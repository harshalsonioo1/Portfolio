    ...
    this.innerRef = N(), this.currentItemRef = N(), this.pillRef = N(), this.handleClickOutside = this.handleClickOutside.bind(this), this.handleItemMouseEnter = this.handleItemMouseEnter.bind(this), this.handleItemsMouseLeave = this.handleItemsMouseLeave.bind(this), this.setActivePathname = this.setActivePathname.bind(this), this.clearActivePathname = this.clearActivePathname.bind(this), this.activeSubmenu = null, this.closingTimeout = null, this.state = {
      ...
      items: [{
        ...
        items: [{
          ...
          url: "https://www.instagram.com/createdbymad/",
          title: "Instagram"
        }, {
          url: "https://twitter.com/createdbymad",
          title: "Twitter"
        }, {
          url: "/privacy-policy",
          title: "Privacy"
...
var an = {
    nikolai: {
      ...
      image: "/images/team/nikolai.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/nikolaisivertsen"
      }, {
        title: "Twitter",
        url: "https://twitter.com/nonscio"
      }]
    },
    thabi: {
      handle: "thabi",
      name: "Rethabile Segoe",
      role: "Engineering",
      bio: "Rethabile enjoys bringing both the technical and visual aspects of digital products to life. Her love for programming is influenced by learning from people with a diverse range of perspectives and voices. She believes that inclusive, future-orientated design and technology is key to shaping the way our society views social inequality and drives change.",
      image: "/images/team/thabi.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/lala.css"
      }, {
        title: "Twitter",
        url: "https://twitter.com/thabisegoe"
      }]
    },
    nicholas: {
      handle: "nicholas",
      name: "Nicholas Christowitz",
      role: "Design",
      bio: "Nicholas is a South African designer and entrepreneur with 11 years experience, ranging from his start in editorial and print design, to identity and product design. Along the way he co-founded Father Coffee, The Bread, and Http Studio. As a designer at MAD he spends his days developing digital identities and trying to finish work early so he can get back to online gaming.",
      image: "/images/team/nicholas.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/nicholaschristowitz"
      }, {
        title: "Twitter",
        url: "https://twitter.com/nchristowitz"
      }]
    },
    sebastian: {
      handle: "sebastian",
      ...
      bio: "Sebastian has been living and working in Berlin for more than a decade. After several years as a freelance User Experience Designer for various agencies and clients \u2013 from blue-chip companies to small startups \u2013 he co-founded MAD to perfect the balance between strategy, design, and tech. Aside from his duties as a father of two, he is responsible for management and strategy at MAD.",
      image: "/images/team/sebastian.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/sebastianwaters"
      }, {
        title: "Twitter",
        url: "https://twitter.com/sebastianwaters"
      }]
    },
    juergen: {
      handle: "juergen",
      name: "J\xFCrgen Hassler",
      role: "Partner / Design",
      bio: "J\xFCrgen is a designer hailing from Austria. With a background in traditional graphic design, he has been creating digital experiences for the last 12 years. He is a former agency creative director turned independent designer and business founder. He co-founded MAD to create a new type of agency that advocates design, culture, and people.",
      image: "/images/team/juergen.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/juergenhassler"
      }, {
        title: "Twitter",
        url: "https://twitter.com/juergenhassler"
      }]
    },
    pascal: {
      handle: "pascal",
      name: "Pascal G\xE4rtner",
      role: "Design",
      bio: "Pascal has worked as a product designer on some of the most well known digital products out there \u2013 from cutting-edge banking apps to Berlin's BVG transport company. Along the way he ran a studio, and built and managed a design team. He's been with MAD since the beginning and continues to shape the type of considered product work MAD has become known for.",
      image: "/images/team/pascal.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/grtner"
      }, {
        title: "Twitter",
        url: "https://twitter.com/pascalgart"
      }]
    },
    veera: {
      handle: "veera",
      name: "Veera Jussila",
      role: "Engineering",
      bio: "Veera Jussila is an artist and programmer who has joined MAD as an intern for spring 2021. She graduated with MA in Computational Arts at Goldsmiths, University of London in 2020. Her background is in long-form feature journalism. She is especially interested in creative uses of machine learning and digital ideas for the arts sector and museums.",
      image: "/images/team/veera.png",
      links: [{
        title: "Instagram",
        url: "https://www.instagram.com/veeraidaj"
      }]
    }
  },
  At = class extends T {
                                                ...
                                                MMMMMMMMMMMMMMMMMAAAAAAAAAADDADDDDDDD D  M
                                                           MMMMMMMMMMMMMMMMAAAAAAAAADDDMMM
                                                                   MMMMMMMMMMMMMMMMMMMMMM
                                                                           MMMMMMMMMMMMM
`,
  Rt = "We're always on the lookout for new people to work with, take a look at https://www.mad.ac/careers or just drop us a casual email at careers@mad.ac and we can take it from there.",
  xi = {
